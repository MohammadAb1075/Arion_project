...
class CheckRequestView(APIView):
    ...
    #             r=str(r)
    #
    #             if (r == 'FacultyTrainingStaff' and opinion.request.state != 1) or(r == 'DepartmentHead' and opinion.request.state != 2) or (r == 'UniversityTrainingStaff' and opinion.request.state != 3):
    #
    #
    #                 return Response(
    #                     {
    ...
    #
    #
    #     # elif request.user.roles.role == "Student":
    #     #     return Response(
    #     #         {
    #     #             'message' : 'InAccessibility !!!'
    #     #         },
